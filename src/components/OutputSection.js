...
const OutputSection = ( {chosenDate , chosenPartySize, loggedIn} ) => {
    ...
    return(
        <div>
            ...
            {timeElements}
            {openModal && <ReservationModal setName={setName} setOpenConfirmationModal={setOpenConfirmationModal} loggedIn={loggedIn} reservationTime={chosenTime} reservationDate={chosenDate} reservationParty={chosenPartySize} closeModal={setOpenModal}/>}
